...
This repository contains the highly optimized, native **Linux** build of Zero Docx. It is engineered from the ground up to utilize native Linux windowing and graphics APIs for zero-latency input and maximum performance, aiming to outperform industry standards.
...
```bash
git clone https://github.com/Suraj-Mavuleti/zero-docx-linux.git
cd zero-docx-linux
make build-linux
```
